...
function load_stylesheets()
{
    ...
    wp_register_style('style', get_template_directory_uri() . '/dist/style.css', array(), false, 'all');
...
function load_js()
{
    ...
    wp_enqueue_script('jquery', get_template_directory_uri() . '/bootstrap/js/jquery-3.6.0.min.js', '', 1, true);
    add_action('wp_enqueue_scripts', 'jquery');

    wp_register_script('bootstrapjs', get_template_directory_uri() . '/bootstrap/js/bootstrap.bundle.min.js', array(), 1, true);
